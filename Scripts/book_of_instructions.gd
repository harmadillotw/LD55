...
func load_page():
	...
	match page:
		1:
			populate_page( Global.instr_5, "", "" ,"res://Images/instructions/book.png" )
		2:
			populate_page( Global.instr_1, "" ,""  ,"res://Images/instructions/alter.png")
		3:
			populate_page( Global.instr_2,""  ,""  , "res://Images/instructions/circle.png")	
		4:
			populate_page( Global.instr_3, "" , "" ,"res://Images/instructions/summon.png" )
		5:
			populate_page( Global.instr_4, "" , "" ,"res://Images/instructions/circle.png" )
